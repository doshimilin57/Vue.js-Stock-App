<template>
  <div class="centered-container">
    <md-content class="md-elevation-3">
      <div class="title">
        <div class="md-title st-title">{{$t('loginTxt')}}</div>
      </div>
      <form class="form-signin" @submit.prevent="auth">
        <div class="form">
          <md-field>
            <label for="email" id="lblEmail">{{$t('email')}}</label>
            <md-input
              type="text"
              id="email"
              placeholder="Ex. abc@gmail.com"
              area-labelledby="lblEmail"
              v-model="login.email"
              autofocus
              :required="true"
            ></md-input>
          ...
          <md-field md-has-password>
            <label for="password" id="lblPassword">{{$t('password')}}</label>
            <md-input
              type="password"
              id="password"
              placeholder="Password"
              area-labelledby="lblPassword"
        ...
        <div class="actions md-layout md-alignment-center-space-between">
          <md-button class="md-raised st-btn" type="submit">{{$t('loginBtn')}}</md-button>
